...
- Stopped clipping the public noise overlay to the land/walking study area; noise geometry can now extend over water while the walking grid and PMTiles score geometry still use the exact coastline.
