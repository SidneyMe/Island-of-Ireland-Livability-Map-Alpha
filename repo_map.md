...
| `tests/test_server_behavior.py` | runtime API shape, transport subtier/mode count exposure, noise count/PMTiles URL exposure, surface/inspect input validation, and range serving for main + noise PMTiles |
