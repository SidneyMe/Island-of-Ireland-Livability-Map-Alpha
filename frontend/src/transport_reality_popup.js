import { transportSubtierLabel } from "./transport_filters.js";
...
function _routeModesText(properties) {
  if (Array.isArray(properties.route_modes)) {
    return properties.route_modes.join(", ");
  }
...
function _rowHtml(properties) {
  const detailLines = [
    "<p><strong>Weekly service:</strong> " + escapeHtml(_tierText(properties)) + "</p>",
